...
/**
 * {@link FilledAdapter} exposes a list of stocks
 * from a {@link android.database.Cursor} to a {@link android.support.v7.widget.RecyclerView}.
 */
public class FilledAdapter extends RecyclerView.Adapter<FilledAdapter.FilledAdapterViewHolder> {
    ...
    final private FilledAdapterOnClickHandler mClickHandler;

    /** The interface that receives onClick messages. */
    public interface FilledAdapterOnClickHandler {
    ...
    /**
     * Creates a FilledAdapter.
     *
     * @param context      Used to talk to the UI and app resources
     */
    public FilledAdapter(@NonNull Context context, FilledAdapterOnClickHandler clickHandler) {
        mContext = context;
     ...
     *                  for more details.
     * @return A new FilledAdapterViewHolder that holds the View for each list item
     */
    @Override
    public FilledAdapterViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {

        View view = LayoutInflater.from(mContext).inflate(R.layout.transaction_list_item,
                viewGroup, false);
        view.setFocusable(true);
        return new FilledAdapterViewHolder(view);
    }
     ...
     *
     * @param FilledAdapterViewHolder The ViewHolder which should be updated to represent the
     *                                  contents of the item at the given position in the data set.
     * @param position                  The position of the item within the adapter's data set.
     */
    @Override
    public void onBindViewHolder(FilledAdapterViewHolder FilledAdapterViewHolder, int position) {
        if (!mCursor.isClosed()) {
            try {
                ...
                /* Set the text */
                FilledAdapterViewHolder.executionPriceView.setText(executionPrice);
     ...
     *
     * @param newCursor the new cursor to use as FilledAdapter's data source
     */
     ...
     */
    public class FilledAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        FilledAdapterViewHolder(View view) {
            super(view);

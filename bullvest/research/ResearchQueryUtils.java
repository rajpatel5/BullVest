 ...
 */
public final class ResearchQueryUtils {

    /** Tag for the log messages */
    private static final String TAG = "TradeQueryUtils";

    /**
     * Create a private constructor because no one
     * should ever create a {@link ResearchQueryUtils} object.
     */
    private ResearchQueryUtils() {
    }
    ...
    public static Stock fetchStockData(String requestUrl) {
        ...
        Stock stocks = extractFeatureFromJson(jsonResponse);

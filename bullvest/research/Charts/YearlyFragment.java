...
public class YearlyFragment extends Fragment implements
    ...
    // Used for logging
    private final String TAG = YearlyFragment.class.getSimpleName();

    /** Constant value for the stock loader ID */
    private static final int STOCK_LOADER_ID = 7;

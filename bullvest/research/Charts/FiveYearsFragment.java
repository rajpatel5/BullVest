...
public class FiveYearsFragment extends Fragment implements
    ...
    // Used for logging
    private final String TAG = FiveYearsFragment.class.getSimpleName();

    /** Constant value for the stock loader ID */
    private static final int STOCK_LOADER_ID = 8;
    ...
    String stockChartUrl = Constants.IEX_REQUEST_URL + stockSymbol +
            Constants.IEX_FIVE_YEARS_PATH_END;
